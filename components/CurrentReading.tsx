...
const books: Book[] = [
  {
    title: "East of Eden",
    coverImage: "/east_of_eden.jpeg",
    author: "John Steinbeck"
  },
  {
    title: "Don't Eat the Marshmallow Yet!",
    coverImage: "/marshmallow.jpg",
    author: "Joachim de Posada and Ellen Singer"
  },
]
...
export function CurrentReading() {
  ...
  return (
    <div className="sticky top-4 w-full h-9/10 overflow-hidden rounded-lg border border-slate-700 bg-gradient-to-b from-slate-800 to-slate-900 p-4 shadow-sm flex flex-col">
